...
@section('content')    
    ...
    <a target="_blank" href="{{route('cotizaciones.listaReporte')}}" class="btn float-right " style="margin-top: 53px;background: rgb(156, 39, 39)" >
        ...
        <span style="font-size: 17px; color: white">Generar PDF</span></a>
