        ...
        <table id="articulos" class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <select name="id_encargado_produccion[]" {{-- id="id_encargado_produccion" --}} class="form-control col-md-4" aria-label="Default select example" tabindex="1">
                            @foreach ($encargados as $encargado)                     
                                    <option  value="{{$encargado->id_encargado_produccion}}">{{$encargado->primer_nombre}} {{$encargado->aoelido_paterno}} {{$encargado->apellido_materno}}</option>
                            @endforeach
                        </select>
                    </td>
                </tr>
