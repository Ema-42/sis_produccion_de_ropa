            ...
            <html lang="en">
              ...
              <body>
                ...
                -->
                    ...
                    <h4 class="texto">Lista de Ingresos :</h4>
                    <table id="pedidos" class="table texto" style="border: 1px solid;text-align: center" >
                        ...
                        <tr >
                            ...
                            <th style="border: 1px solid" scope="col">Proveedor Empresa</th>
                            <th style="border: 1px solid" scope="col">Proveedor Representante</th>
                        ...
                        <tbody >
                            @foreach ($ingresos as $ingreso)
                                ...
                                <tr >
                                    <td style="border: 1px solid">{{$ingreso->id_ingreso}}</td>
                                    <td style="border: 1px solid">{{$ingreso->users->name}}</td>
                                    <td style="border: 1px solid">{{$ingreso->empresas->nombre}}</td>
                                    <td style="border: 1px solid">{{$ingreso->proveedores->nombre_empresa}}</td>
                                    <td style="border: 1px solid">{{$ingreso->proveedores->primer_nombre}} {{$ingreso->proveedores->apellido_paterno}}</td>
                                    <td style="border: 1px solid">{{$ingreso->created_at}}</td>
                                    <td style="border: 1px solid">{{$ingreso->fecha_entrega}}</td>
                                    <td style="border: 1px solid">{{$ingreso->comentarios}}</td>
                                    <td style="border: 1px solid"><span style="font-size: 14px" {{-- class="badge badge-success  d-inline" --}}>{{$ingreso->total}}</span></td>
                                </tr>
                                @endif
                            @endforeach
                        </tbody>   
