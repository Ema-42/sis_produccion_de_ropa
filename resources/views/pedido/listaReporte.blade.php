            ...
            <html lang="en">
              ...
              <body>
                ...
                -->
                    ...
                    <h4 class="texto">Lista de Pedidos :</h4>
                    <table id="pedidos" class="table texto" style="border: 1px solid;text-align: center" >
                        ...
                        <tbody >
                            @foreach ($pedidos as $pedido)
                                ...
                                <tr >
                                    <td style="border: 1px solid">{{$pedido->id_pedido}}</td>
                                    <td style="border: 1px solid">{{$pedido->users->name}}</td>
                                    <td style="border: 1px solid">{{$pedido->empresas->nombre}}</td>
                                    <td style="border: 1px solid">{{$pedido->clientes->primer_nombre}} {{$pedido->clientes->apellido_paterno}}</td>
                                    <td style="border: 1px solid">{{$pedido->created_at}}</td>
                                    <td style="border: 1px solid">{{$pedido->fecha_entrega}}</td>
                                    <td style="border: 1px solid">{{$pedido->comentarios}}</td>
                                    <td style="border: 1px solid"><span style="font-size: 14px" {{-- class="badge badge-success  d-inline" --}}>{{$pedido->total}}</span></td>
                                </tr>
                                @endif
                            @endforeach
                        </tbody>   
