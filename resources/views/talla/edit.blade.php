...
@section('content')
    <form action="/tallas/{{$talla->id_talla}}" method="POST"  class="row g-3" >
        @csrf
        @method('PUT')
        ...
        <div class="mb-3 col-md-4">
            ...
            <input id="descripcion" name="descripcion" type="text" class="form-control " tabindex="2" value="{{$talla->descripcion}}">
        </div>
